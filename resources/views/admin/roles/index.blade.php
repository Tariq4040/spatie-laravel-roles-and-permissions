...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div>
            <h1 class="text-center text-primary m-4">User Roles DashBoard</h1>
            <div class="py-12">
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($roles as $role)
                                            <tr>
                                                ...
                                                <td>{{ $role->updated_at == NULL ? "Date Not Set": Carbon\Carbon::parse($role->updated_at)->diffforhumans()}}</td>

                                                <td>
                                                    <a href="{{ url('admin/role/edit/'.$role->id) }}" class="btn btn-sm btn-primary pr-2">Edit</a>
                                                    <a href="{{ url('admin/role/delete/'.$role->id) }}" class="btn btn-sm btn-danger"
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.roles-create') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control mb-2" placeholder="Enter Your Permission" value="{{ old('name') }}" require>
