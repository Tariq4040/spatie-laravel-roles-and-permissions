...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div>
            <h1 class="text-center text-primary m-4">Edit/Update Permissions DashBoard</h1>
            <div class="py-12">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="row" style="margin: 10px;width: 950px;">
                        ...
                        <div class="col-md-8" style="margin-left: 120px;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ url('admin/permission/update/'.$permissions->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                            <div class="form-group">
                                                <label for="name">Edit Permission</label>
                                                <input type="text" name="name" class="form-control mb-2" value="{{ $permissions->name }}" require>
